...
const CreateSessionForm = () => {
    ...
    const handleCreateSession = async(e) => {
        ...
        if(!role || !experience || !topicsToFocus) {
            setError("Plz fill all the required fields");
            return;
        }
        setError("");
        setIsLoading(true);
  ...
  return (
    <div className='w-full max-w-[400px] px-4 py-6 sm:p-7 flex flex-col mx-auto'>
        ...
        <p className='text-xs text-slate-700 mt-[5px] mb-3'>
            Fill out a few quick details & unlock your personalized set of Interview Quesitons!
        </p>
        ...
        <form onSubmit={handleCreateSession}
            className='flex flex-col gap-2'>
                ...
                <Input
                    ...
                    placeholder="(e.g. 1yr, 2yr's, 5+ yrs)"
                    type="number"
                />
    ...
    disabled={isLoading}
>
    {isLoading && <SpinnerLoader size="lg" color="white" />}
    Create Session
</button>
        </form>
    </div>
