...
const ChallengeCard = ({ challenge }) => {
  return (
    <Link
      ...
      className="group block bg-white/90 backdrop-blur-sm border border-white/60 rounded-2xl p-5 shadow-sm hover:shadow-lg hover:border-blue-200 transition-all duration-200"
    >
