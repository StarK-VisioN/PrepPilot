            ...
            <div className='text-[14px] prose prose-slate dark:prose-invert max-w-none'>
                <ReactMarkDown
                    ...
                    components={{
                        ...
                        ul({ children }) {
                            return <ul className='list-disc pl-6 space-u-2 my-4'>{children}</ul>
                        },
                        ol({ children }) {
                            return <ol className='list-decimal pl-6 space-u-2 my-4'>{children}</ol>
                        },
                        li({ children }) {
                        ...
                        th({ children }) {
                            return <th className='px-3 py-2 text-left text-sm font-medium text-gray-500 uppercase tracking-wider'>{children}</th>
                        },
                        td({ children }) {
