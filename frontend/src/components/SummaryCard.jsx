    ...
    <div className="bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group" 
      ...
      <div className="px-3 pb-3">
        <div className="flex items-center gap-3 mt-4">
            ...
            <div className="text-[10px] font-medium text-black px-3 py-1 border-[0.5px] border-gray-900 rounded-full">{questions?.length || 0} Q&A</div>
        ...
        {/* Description */}
        <p className="text-[14px] text-gray-500 font-medium mt-3">{description}</p>
      </div>
    </div>
  );
};
